...
after data $x \in \sX$ is observed.
...
\begin{definition}
 A \summ\ $\phi$ is a 
 \stdsumm\ if $\phi$ takes values in $\{0,1\}$.
\end{definition}
...
This paper studies whether logically coherent \summ's are coherent representations of uncertainty. 
